  ...
  return (
    <div className={`${styles.postContent} mb-4`}>
      ...
      <div className={`${styles.postText}`}>
        <p>
          تعتبر القراءة من أهمّ المهارات المكتسبة التي تحقق النجاح والمتعة لكل
          فرد خلال حياته، وذلك انطلاقاً من أن القراءة هي الجزء المكمل للحياة
          الشخصية والعملية وهي مفتاح أبواب العلوم والمعارف المتنوعة. مهارة
          القراءة لا يكفي بذكاء الطالب، بل يهتمّ بوجود العوامل الخارجية
          والداخلية المشجّعة على القراءة.
        </p>
